  ...
  return (
    <div className="w-80 bg-slate-900 text-slate-100 flex flex-col h-full border-r border-slate-800">
      <div className="p-6">
        ...
        <button 
          onClick={onNewChat}
          className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 transition-colors py-2.5 rounded-lg font-medium mb-8 active:scale-95 transform"
        >
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            {TEMPLATES.map((t, idx) => (
              ...
              >
                <div className="mt-1 text-indigo-400 group-hover:text-indigo-300">
